...
from datasets.alphabets import plateName,plate_chr
...
def parse_arg():
    ...
    parser.add_argument('--cfg', type=str,default='lib/config/360CC_config.yaml',help='experiment configuration filename')
